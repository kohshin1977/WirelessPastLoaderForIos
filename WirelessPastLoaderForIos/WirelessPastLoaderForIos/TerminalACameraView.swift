...
struct TerminalACameraView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 16) {
                HStack {
                    TextField("送信先IPアドレス", text: $ipAddress)
        ...
        .navigationBarTitle("端末A - カメラ", displayMode: .inline)
        .onAppear {
